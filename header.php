    ...
    <header>
      ...
      <?php if( have_rows('header_info','options') ): ?>
        <?php while( have_rows('header_info','options') ): the_row(); 
          ...
          <nav class="navbar navbar-expand-xxl navbar-dark navbar-toggleable-xxl bg-dark navbar-collapse">
            <div class="container-fluid">
              ...
              <a class="navbar-brand" href="#"><button class="btn-cta">Let's talk</button></a>
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="navmenu-left">
                     ...
                     <div class="create-project text-center text-white">
                      <button class="btn btn-project text-white" src="">Start a Project</button>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6 col-md-6 col-sm-12 col-xs-12 bg-white">
                  <div class="navmenu-right bg-white text-dark">
